...
class Images:
    ...
    def download_imagethumb(self, image_id: int, w=64, z=0, t=0, explicit=False) -> str:
        ...
        #     fname = os.path.join(self.save_path, '{}thumbnail_w{}_z{}_t{}.jpg'.format(image_id, w, z, t))
        # else:
        #     fname = os.path.join(self.save_path, '{}thumbnail.jpg'.format(image_id))

        fname = os.path.join(self.save_path, '{}_thumbnail.jpg'.format(image_id))
